...
knitr::knit_hooks$set(document = function(x) {
  unlink("rapport_files", recursive = TRUE)
  unlink(".Rhistory")
  x
})
```
...
|--------|-------------------|
| Samuel FANDIO NJIKAM | Introduction, Q2, Q6, Q7, Q9, Q12, Q16, Q19 et structure globale du rapport |
| Samella LEUKOUO | Q1, Q3, Q4, Q8, Q10, Q13 |
