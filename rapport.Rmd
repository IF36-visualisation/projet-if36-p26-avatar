...
## Axe 1 — Distributions et structure
### Q2 — Le nombre d'évaluations est-il suffisant pour que les notes soient fiables ?
Le dataset contient des vins notés par un nombre très variable d'utilisateurs : de 25 avis seulement jusqu'à plus de 20 000. Une note de 4,5 basée sur 30 avis n'a pas la même valeur statistique qu'une note de 4,5 basée sur 2 000 avis. 
Avant toute analyse comparative, il est donc indispensable de quantifier ce biais et de définir un **seuil de fiabilité** que nous appliquerons comme filtre dans les axes suivants.

On s'attend à observer une forte dispersion verticale des notes pour les vins peu évalués, qui se réduira progressivement à mesure que le nombre d'avis augmente.
...
Le boxplot confirme l'intuition de départ. Les deux premières tranches (25–49 et 50–99 avis) présentent les boîtes les plus larges et les moustaches les plus étendues (des notes allant de 2.7 à 4.8), traduisant une forte instabilité : ces vins sont notés par un cercle restreint et potentiellement partial d'utilisateurs, ce qui ne permet pas de dégager une note représentative.

À partir de 100 avis, la dispersion se resserre nettement et se stabilise sur les tranches 100–199, 200–499 et 500–999 : les médianes convergent autour de 3.9 et les IQR se réduisent, signe que la note reflète désormais un consensus réel. Le seuil de 100 avis est donc retenu comme filtre de fiabilité pour toutes les analyses ultérieures.

La tranche 1000+ présente une boîte légèrement plus large. Non pas par manque de fiabilité, mais par un biais de sélection inverse : les vins accumulant autant d'avis sont les grands noms très médiatisés (Champagnes de prestige, premiers crus bordelais), des bouteilles qui polarisent les opinions entre amateurs convaincus et consommateurs qui les jugent surévaluées. C'est un phénomène distinct du bruit statistique observé à gauche du seuil.
